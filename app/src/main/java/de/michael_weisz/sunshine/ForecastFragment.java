...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList weatherList = fetchWeatherData("Potsdam, Germany");

        weatherDataAdapter = new ArrayAdapter<String>(
                getActivity(),                      // Context
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.forecasting_fragment, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_refresh){
            ...
            new FetchWeatherTask().execute("14482");
            return true;
        }
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder()
                        ...
                        .appendQueryParameter("cnt", "" + DAYS_IN_ONE_WEEK);
                ...
                weatherDataString = getWeatherDataFromJson(forecastJsonStr, DAYS_IN_ONE_WEEK );
            } catch (IOException e) {
    ...
    public static ArrayList<String> fetchWeatherData(String city){
